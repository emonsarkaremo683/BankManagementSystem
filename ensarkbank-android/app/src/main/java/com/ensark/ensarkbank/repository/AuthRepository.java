...
public class AuthRepository {
    ...
    public void verifyEmail(String token, Callback<Map<String, String>> callback) {
        apiService.verifyEmail(token).enqueue(callback);
    }

    public void sendVerification(ForgetPasswordRequest dto, Callback<Map<String, String>> callback) {
        apiService.sendVerification(dto).enqueue(callback);
    }

    public void forgotPassword(ForgetPasswordRequest dto, Callback<Map<String, String>> callback) {
        apiService.forgotPassword(dto).enqueue(callback);
    }

    public void resetPassword(ResetPasswordRequest dto, Callback<Map<String, String>> callback) {
