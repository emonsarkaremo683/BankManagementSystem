...
public class LoanApplicationActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.toolbar.setTitle("Apply for Loan");
        binding.toolbar.setNavigationIcon(androidx.appcompat.R.drawable.abc_ic_ab_back_material);
        binding.toolbar.setNavigationOnClickListener(v -> finish());
        String[] types = new String[]{"PERSONAL","HOME","AUTO","EDUCATION"};
        binding.actDropdown.setAdapter(new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, types));
        binding.btnSubmit.setOnClickListener(v -> Toast.makeText(this,"Loan apply wired",Toast.LENGTH_SHORT).show());
    }
}
