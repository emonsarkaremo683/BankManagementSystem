...
public interface AuthApiService {
    ...
    Call<Map<String, String>> verifyEmail(@Query("token") String token);

    @POST("api/auth/send-verification")
    Call<Map<String, String>> sendVerification(@Body ForgetPasswordRequest dto);

    @POST("api/auth/forgot-password")
    Call<Map<String, String>> forgotPassword(@Body ForgetPasswordRequest dto);

    @POST("api/auth/reset-password")
    Call<Map<String, String>> resetPassword(@Body ResetPasswordRequest dto);
