...
public class GeneralRepository {
    ...
    public void getAllDivisions(Callback<List<DivisionResponse>> callback) {
        apiService.getAllDivisions().enqueue(callback);
    }

    public void getDistrictsByDivision(Long divisionId, Callback<List<DistrictResponse>> callback) {
        apiService.getDistrictsByDivision(divisionId).enqueue(callback);
    }

    public void getPoliceStationsByDistrict(Long districtId, Callback<List<PoliceStationResponse>> callback) {
        apiService.getPoliceStationsByDistrict(districtId).enqueue(callback);
    }
