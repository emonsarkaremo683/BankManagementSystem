...
public class BeneficiaryRepository {
    ...
    public void initiateVerification(Long id, Callback<Map<String, String>> callback) {
        apiService.initiateVerification(id).enqueue(callback);
    }

    public void verify(Long id, String otpCode, Callback<Map<String, String>> callback) {
        apiService.verify(id, otpCode).enqueue(callback);
    }

    public void delete(Long id, Callback<Map<String, String>> callback) {
