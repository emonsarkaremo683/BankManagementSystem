...
public class BeneficiaryController {
    ...
    public ResponseEntity<String> initiateVerification(@PathVariable Long id) {
        beneficiaryService.initiateVerification(id);
        return ResponseEntity.ok("Verification code sent to your registered email");
    }

    @PreAuthorize("hasRole('CUSTOMER') and @customerSecurity.isBeneficiaryOwner(#id, authentication)")
    @PostMapping("{id}/verify")
    public ResponseEntity<String> verify(@PathVariable Long id, @RequestParam String otpCode) {
